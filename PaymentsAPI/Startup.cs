...
namespace PaymentsAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = Configuration["connectionStrings:dbConnectionString"];
            services.AddDbContext<PaymentDBContext>(options => options.UseSqlServer(connection));

        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, PaymentDBContext dbConext)
        {
